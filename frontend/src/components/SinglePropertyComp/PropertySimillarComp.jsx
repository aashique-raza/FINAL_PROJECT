...
function PropertySimillarComp({ data }) {
  const { category, id } = useParams();
  console.log(category)

  console.log("bhk type", data.BHKType);
  return (
    <NavLink
      to={`property/${category}/${data._id}`} // Update this to the actual route you want to navigate to
